...
**한 줄 요약:** 비개발자용 완전 오프라인 데스크톱 변환기 (Windows 우선, mac 개발) — 문서(DOCX→PDF, PDF→TXT/DOCX, HWP 읽기) + 데이터(CSV↔XLSX, CSV↔JSON), 원스크린 드롭존, 일괄 변환, 원본 절대 보호. 스택: Python + PySide6 + LibreOffice 번들 (DEC-001).
