...
from . import data, hwp, hwpx, image, markup, model3d, office, pdf, pdf_docx, pdf_pptx, video
...
TARGETS: dict[str, list[str]] = {
    ...
    "pdf": [
        ...
        "jpg",
        "pptx",
    ],  # DEC-023 — HWP/HWPX도 텍스트 기반(DEC-010과 같은 원칙, hwpx는 DEC-049). png/jpg: DEC-026, 페이지별 이미지를 폴더에 저장(jpg 옵션은 DEC-043). pptx: DEC-030, 줄 단위 위치 재구성(이미지로 뭉개지 않음)
    "hwp": ["txt", "pdf", "docx"],
